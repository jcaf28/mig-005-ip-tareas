...
Public Sub MigracionUsuariosAnotaciones()
    ...
    Call ImportarDesdeExcel(ARCHIVOS_PATH & "\T_PROCESOS_SUBIR.xlsx", "T_PROCESOS", logStr, totalIntentados, totalInsertados)
    
    ' Importar grupos
    logStr = logStr & vbCrLf & ">> Insertando TJ_GRUPOS_SUBIR.xlsx en TJ_GRUPOS..." & vbCrLf
    Call ImportarDesdeExcel(ARCHIVOS_PATH & "\TJ_GRUPOS_SUBIR.xlsx", "TJ_GRUPOS", logStr, totalIntentados, totalInsertados)
    
    ' Importar tareas
    logStr = logStr & vbCrLf & ">> Insertando T_TAREAS_SUBIR.xlsx en T_TAREAS..." & vbCrLf
    Call ImportarDesdeExcel(ARCHIVOS_PATH & "\T_TAREAS_SUBIR.xlsx", "T_TAREAS", logStr, totalIntentados, totalInsertados)
